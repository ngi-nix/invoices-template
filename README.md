...
> [!CAUTION]
> Do **NOT** use the invoice generated by this repo directly, for Legal reasons depending on where you reside, you might be required to follow strict Invoicing procedure.
> Use this repository as a reference and an example to simplify your timesheet tracking and exporting workflow.
>
> If you are absolutely sure there are no legal regulations which apply for your invoicing, you can use this as is, if you like the workflow described here.
